...
Sample usage from an irb console
  ...
  > sld = lyr.styles.first
  > sld.profile
  {"name"=>"grass", "sld_version"=>"1.0.0", "filename"=>"grass_poly.sld", "sld"=>{"sld_name"=>"grass", "sld_title"=>"Grass fill"}}
...
- Complete data stores and coverages functionality, handle Layers, styles and data upload.
