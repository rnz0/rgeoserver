...
== Contributors
This package will be supported and maintained by {Stanford University Libraries}[http://library.stanford.edu/].

== License 

Copyright (c) 2012 Renzo Sanchez-Silva <renzo.sanchez.silva@gmail.com>.
